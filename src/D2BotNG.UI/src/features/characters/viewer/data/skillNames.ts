/**
 * D2 skill id -> name, generated from kolbot's sdk/txt/skills.txt (skill id = row).
 * The character-state sender emits raw skill ids for skills with hard points
 * invested, so in practice these resolve to the character's class skills.
 */
