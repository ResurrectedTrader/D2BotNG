...
export function SettingsPage() {
  ...
  // Initialize local state when settings load. isDirty is deliberately left alone: a
  // failed save produces no broadcast, so the flag has to survive for the retry.
  useEffect(() => {
    if (settings) {
